...
# API_KEY = os.getenv("GEMINI_API_KEY") # Get free key from console.groq.com
...
# def extract_json_from_text(text: str):
#     """
#     Extracts the first valid JSON block from AI output.
#     Cleans code fences and other text wrappers.
#     """
#     if not text:
#         return None
...
# def get_ai_forecast(company_name, signal_summary, news_summary):
#     """
#     Calls Groq AI to predict the next 6–12 month stock outlook.
#     Returns parsed JSON dict.
#     """
...
#         except Exception as e:
#             if attempt == retries - 1:
#                 print(f"⚠️ AI call failed for {company_name}: {e}")
#                 return {
#                     "prediction": "Neutral",
#                     "expected_change_6m": "0%",
#                     "expected_change_1y": "0%",
...
#         "expected_change_1y": "0%",
#         "confidence": "Low",
#         "reasoning": "AI did not return a usable forecast after retries.",
#     }
...
#         # Small delay to respect rate limits (Groq is fast, minimal delay needed)
#         time.sleep(0.5)
